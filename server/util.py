...
if __name__ == '__main__':
    ...
    # print(classify_image(None, "./test_images/1.jpeg"))
    # print(classify_image(None, "./test_images/babasaheb.png"))
    # print(classify_image(None, "./test_images/maria-sharapova.jpg"))